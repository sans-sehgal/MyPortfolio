            ...
            <div>
              <Fade bottom duration={1200}>
                ...
                <blockquote className='mt-6 text-xl leading-8 italic text-customGradient-300 border-l-4 border-customGradient-200 pl-4'>
                  “Do, or do not. There is no 'try.' ” - <strong>Yoda</strong>
                </blockquote>
              </Fade>
            </div>
          ...
          <div className='mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 '>
            <Fade bottom duration={1500}>
              <article className='flex max-w-xl flex-col items-start justify-between border-l border-gray-200 pl-8'>
                ...
                <p className='mt-5 text-sm leading-6 text-customGradient-200'>
                  I adeptly navigate various programming paradigms and
                  languages, including JavaScript, TypeScript, Python, Java, and
                  C++. Proficient in Agile, Scrum, and Jira for project
                  management.
                </p>
              </article>
            </Fade>
            <Fade bottom duration={1700}>
              <article className='flex max-w-xl flex-col items-start justify-between border-l border-gray-200 pl-8'>
                ...
                <p className='mt-5  text-sm leading-6 text-customGradient-200'>
                  Crafting beautiful websites using HTML/CSS/JS/TS, React,
                  Bootstrap, Redux, SASS and Material UI is my forte. I utilize
                  Jest and React Testing Library for writing unit tests. I
                  elevate web design to a new level.
                </p>
              </article>
            </Fade>
            <Fade bottom duration={1900}>
              <article className='flex max-w-xl flex-col items-start justify-between border-l pl-8'>
                ...
                <p className='mt-5 text-sm leading-6 text-customGradient-200'>
                  Experience with technologies such as Node.js, Express, and
                  GraphQL. Skilled in database management using PostgreSQL,
                  MongoDB, and DynamoDB, and excel in integrating RESTful APIs.
                </p>
              </article>
            </Fade>
          </div>
